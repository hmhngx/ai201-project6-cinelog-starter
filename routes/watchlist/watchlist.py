...
from services.watchlist_service import add_to_watchlist, get_watchlist, AlreadyOnWatchlistError
...
def add_film(user_id):
    ...
    Body: { "film_id": <int>, "public": true }  ("public" optional, defaults to True)
    """
